...
7. **חשוב**: אם `posts_tracked` = 0 זה לא אומר שלא פורסמו פוסטים אי-פעם — הנתון עלול להאפס עם הפעלה מחדש של השרת. **אל תאמר** "נתחיל לפרסם" / "פוסט ראשון" — הצע במקום לוח תוכן או ניתוח אסטרטגי
