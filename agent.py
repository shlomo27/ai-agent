...
7. אם אין `recent_posts` ב-Facebook — ציין שהנתונים ידרשו הרשאות נוספות, **אל תכתוב** "ניתן לראות ב-Business Manager" — הכוונה היא שיהיה הכל כאן
8. **אסור** להציע "להגדיר פרופיל עסקי" במסגרת ניתוח ביצועים — המשתמש כבר פרסם ויש לו פרופיל
9. אם `posts_tracked` = 0 — אל תאמר "עדיין לא פרסמנו" — ייתכן שהנתון אופס עם הפעלה מחדש של השרת
