...
```
כדי לכתוב פוסט ממוקד, כמה שאלות קצרות —
(ענה על מה שרלוונטי, השאר ריק את השאר):

1️⃣ מה [שם המוצר] עושה / מציע?
2️⃣ מי קהל היעד? (גיל, תחום עניין, מיקום)
3️⃣ יש משהו ספציפי שחשוב לך שנדגיש? (מבצע, פיצ'ר, יתרון)
4️⃣ לפרסם גם בקבוצות רלוונטיות? (כן / לא / אתה תחליט)
```
...
### אחרי הטיוטה:
שאל **רק**: "האם לאשר ולפרסם? (כן / לא / שינויים)"
